...
namespace Backend_Capstone.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageUrl,Title,PrepTime,CookTime,Servings,Description,CuisineId,ApplicationUserId,DateAdded")] Recipe recipe)
        {
